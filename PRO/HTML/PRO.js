...
/* tip_search */
var s = new Array();
s[0]="AUTHENTIFICATION^index.htm^0<div></br></div>^^0";
s[1]="Création compte^creation_compte.htm^0<div></br></div>^^0";
s[2]="Reste le mot de passe^reste_le_mot_de_passe.htm^0<div></br></div>^^0";
s[3]="LES DROITS D'ACCES^les_droits_d_acces.htm^0<div></br></div>^^0";
s[4]="Directeur ^directeur_.htm^0<div></br></div>^^0";
s[5]="Assistant^assistant_0.htm^0<div></br></div>^^0";
s[6]="Conseil scientifique^conseil_scientifique.htm^0<div></br></div>^^0";
s[7]="RECHERCHE^recherche.htm^0<div></br></div>^^0";
s[8]="Simple^simple.htm^0<div></br></div>^^0";
s[9]="Avancée^avancee.htm^0<div></br></div>^^0";
s[10]="MISE A JOUR^mise_a_jour.htm^0<div></br></div>^^0";
s[11]="Ajouter un chercheur^ajouter_un_chercheur.htm^0<div></br></div>^^0";
s[12]="Ajouter un laboratoire^ajouter_un_laboratoire.htm^0<div></br></div>^^0";
s[13]="Ajouter un stage^ajouter_un_stage.htm^0<div></br></div>^^0";
s[14]="Ajouter une université^ajouter_une_universite.htm^0<div></br></div>^^0";
s[15]="NOTIFICATION^notification.htm^0<div></br></div>^^0";
s[16]="Retour de satage^retour_de_satage.htm^0<div></br></div>^^0";
s[17]="BASE DE DONNEE^base_de_donnee.htm^0<div></br></div>^^0";
s[18]="Visualise^visualise.htm^0<div></br></div>^^0";
s[19]="Sauvgarde^sauvgarde.htm^0<div></br></div>^^0";
