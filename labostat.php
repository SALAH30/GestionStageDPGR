          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="box box-danger">
                <div class="box-header">
                  <h3 class="box-title">Les Frais des Stages de Chercheur</h3>
                </div>
                <div class="box-body">
...
<?php
    function data_base_connect ()
   {
     ...
     return ($dbh);
              ...
              $st = $db->prepare("SELECT Chercheur.Code FROM Chercheur JOIN Laboratoire WHERE Chercheur.Laboratoire_Code=Laboratoire.Code");            
              $st->execute();
              while($row = $st->fetch())
              {
                $cmp++;
