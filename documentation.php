     ...
     return ($dbh);
        ...
        ?> 
                 ...
                 <ul class="ca-menu" style="margin-left:10%;margin-top:80px;">
                    <li>
                        <a href=<?php echo $Attestation;?> data id="submit1" target="_blank">
                    ...
                    <li>
                        <a href=<?php echo $fraii;?> data id="submit2" target="_blank">
                    ...
                    <li>
                        <a href=<?php echo $fraia;?> data id="submit3" target="_blank">
                    ...
                    <li>
                        <a href=<?php echo $Billet;?> data id="submit4" target="_blank">
