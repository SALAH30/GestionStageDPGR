              ...
              <?php if($_SESSION['type'] == 'DG'){ ?>
				...
				<?php if( $_SESSION['type'] != 'CS'){?>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                           <li><a style="color:white;" href="base table.php">Tables de la BDD</a></li>
      ...
      <section id="main-content">
          <section class="wrapper"  style="background-color:#F2F2F2;">
             <header style="margin:40px 0;">
				...
				<p>Afficher tous les tableaux de la base de données</p>
                                 ...
                                 {?>
                                    <tr>
                                        ...
                                        <td><?php echo $row['Site_Web'] ?></td>
                                         <td><?php 
                                        $st = $db->prepare('SELECT Nom_Fr FROM Université WHERE Code='.$row['Université_Code']);
                                        $st->execute();
                                        while($option = $st->fetch())
                                        {  echo $option['Nom_Fr']; }  
                                         ?>
                                        </td>                       
                                       <?php if( $_SESSION['type'] != 'CS'){?>
   ...
   <!--Fonction d'aficher la notice en bulle-->
	<script type="text/javascript">
        ...
        var unique_id = $.gritter.add({
            ...
            text: 'Bounjour monsieur, si vous vouler consulter l\'aide de l\'application <a href="PRO/HTML/visualise.htm" target="_blank" style="color:#ffd777"><h7>help!</h7></a>',
