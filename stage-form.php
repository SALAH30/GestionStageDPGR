        ...
        <?php if( $_SESSION['type'] != 'CS'){?>
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a  style="color:white;" href="stage-form.php#">Stage</a></li>
    ...
    <section class="wrapper">
        <div id="content">
            <div class="inner"  style="background-color:#F2F2F2;">
                <form method="post" action="Stage.php" id="form1" class="form-horizontal block-validate popup-validation">
                    <hr />
                    <div class="row">
                ...
                <section>
                     <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" id="digit" name="digit" class="validate[required,custom[onlyNumberSp]] form-control" title=" " autofocus/>
  ...
  function data_base_connect ()
   {
     ...
     return ($dbh);
          ...
          <option value='<?php echo $option['Code'] ?>' ><?php echo $option['Nom_Fr'].' '.$option['Prénom_Fr']; ?></option>
                 <?php } ?>
</select>   
                    </div> 
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="reservation1" name="reservation1" required/>
                    ...
                    <div class="form-group">  
                        ...
                        <div class="input-group">
                            <input type="number" min="1" max="1000" class="form-control validate[required,custom[onlyNumberSp]]" name="Dure" id="Dure" value="30" title=" " style="width:80px;">  
                            <span class="input-group-addon" style="height:20px;width:180%;">
                            <input type="range" min="1" max="1000" style="color:#868686;width:100%;height:5px;margin-left:5px;" value="30" step="1" name="pow" id="pow" list="powers">
                            </span>
                            <datalist id="powers" >
                                <option value="250">
                                <option value="500">
                ...
                <section>
                    <div class="form-group" >
                        ...
                        <select class="form-control chzn-select" tabindex="-1" name ="Pays">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" id="required1" name="required1" autocomplete="off" class="form-control" data-provide="typeahead" data-items="8" data-source='["Adrar","Chlef","Laghouat","Oum El Bouaghi","Batna","Béjaia","Biskra","Béchar","Blida","Bouira","Tamanrasset","Tébessa","Tlemcen","Tiaret","Tizi Ouzou","Alger","Djelfa","Jijel","Sétif","Saïda","Skikda","Sidi Bel Abbès","Annaba","Guelma","Constantine","Médéa","Mostaganem","Msila","Mascara","Ouargla","Oran","Bayadh","Illizi","Bordj Bou Arreridj","Boumerdès","El Tarf","Tindouf","Tissemsilt","El Oued","Khenchela","Souk Ahras","Tipaza","Mila","Aïn Defla","Naâma","Aïn Témouchent","Ghardaïa","Relizane","Paris","Marseille","Lyon","Toulouse","Nice","Nantes","Strasbourg","Montpellier","Bordeaux","Lille","Rennes","Le Havre","Reims","Saint-Étienne","Toulon","Grenoble","Angers","Dijon","Brest","Le Mans","Clermont-Ferrand","Amiens","Aix-en-Provence","Limoges","Nîmes"]'/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">   
                            <input type="text" id="required" name="required" class="form-control" />
                ...
                <section>
                    <br>
                     <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" id="require22" name="require22" class="form-control" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">    
                            <input type="url" value="http://" id="url2" name="url2" class="form-control" />
                ...
                <section>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" id="digits0" name="digits0" class="form-control"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" id="digits1" name="digits1" class="form-control validate[required,custom[number]]" title=" "/>
                            <span class="input-group-addon"><i class="fa fa-dollar"></i></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" id="digits2" name="digits2" class="form-control validate[required,custom[number]]" title=" "/>
                            <span class="input-group-addon"><i class="fa fa-dollar"></i></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" id="digits3" name="digits3" class="form-control validate[required,custom[number]]" title=" "/>
                            <span class="input-group-addon"><i class="fa fa-dollar"></i></span>
                        </div>          
                    </div>
                </section>
                ...
                <section>
                    <p style="color:gray;font-size:1.3em;">
                        <b style="margin-left:200px;text-transform:uppercase;">Choix de Stagiére</b> <br /><br /><br />
                        Le stage est soit un stage de perfectionnement ou une manifestation.<br /><br /><br />
                        Veuillez choisir le type de stage parmi qui convient :<br /><br />
                        <button style="margin-left:100px;" type="button" class="btn btn-primary btn-lg" id="aissa">Perfectionnement</button>
                        <button style="margin-left:130px;" type="button" class="btn btn-primary btn-lg" id="belkaid">Manifestation</button> 
    ...
    <script>
       ...
       $("#wizardV").on('click','#aissa',function(){
           wizard.steps("add", {
                ...
                content: '<div class="form-group"><label for="req" class="control-label">Objectif</label><div class="input-group"><textarea style="min-height:130px;" class="form-control" name="req" id="req"></textarea><span class="input-group-addon"><i class="fa fa-text"></i></span></div></div><div class="form-group"><label for="req1" class="control-label">Missions</label><div class="input-group"><textarea style="min-height:130px;" class="form-control" name="req1" id="req1"></textarea><span class="input-group-addon"><i class="fa fa-text"></i></span></div></div>'
            }); 
            $(function () { formValidation();});
            $(function () { formInit();});
            wizard.steps("next");
    ...
    $("#wizardV").on('click','#belkaid',function(){
           wizard.steps("add", {
                ...
                content: '<br \><div class="form-group"><label for="requi3" class="control-label">Désignation</label><input type="text" class="form-control" name="requi3" id="requi3"></div><div class="form-group"><label for="requi4" class="control-label">Acronyme</label><input type="text" class="form-control" name="requi4" id="requi4"></div><div class="form-group"><label for="req9" class="control-label">Titre d\'article</label><div class="input-group"><input type="text" class="form-control validate[required]" name="req9" id="req9" title=" "><span class="input-group-addon"><i class="fa fa-pencil"></i></span></div></div><div class="form-group"><label for="digits4" class="control-label">Frais d\'inscription</label><div class="input-group"><input type="text" id="digits4" name="digits4" class="form-control validate[required,custom[number]]" title=" "/><span class="input-group-addon"><i class="fa fa-dollar"></i></span></div></div>'
            }); 
           wizard.steps("add", {
                title: "Extra", 
                content: '<br \><br \><br \><div class="form-group"><label for="requi5" class="control-label">Téléphone</label><div class="input-group"><input class="form-control" type="text" id="requi5" name="requi5"/><span class="input-group-addon"><i class="fa fa-phone"></i></span></div></div><div class="form-group"><label for="email4" class="control-label">Email</label><div class="input-group"><input type="email" id="email4" name="email4" class="form-control" /><span class="input-group-addon"><i class="fa fa-envelope"></i></span></div></div><div class="form-group"><label for="url" class="control-label">Site Web</label><div class="input-group"><input type="url" value="http://" id="url" name="url" class="form-control" /><span class="input-group-addon"><i class="fa fa-site"></i></span></div></div>'
            }); 
            $(function () { formValidation(); });
            $(function () { formInit();});
            wizard.steps("next");
    ...
    <script>
        ...
        $(function () { formInit();});
          var day= new Date(),mois1,mois2,jour1,jour2,
            month= new Date(day.getTime() + 2505600000);
        ...
        $("#pow").on ('change', function () {
            ...
            var changer = new Date(Date.parse(retour)+ ((this.value - 1) * 86400000));
        ...
        document.querySelector(".ranges").addEventListener('click',function() {
            if (myString.value!= "") {
                ...
                var duree = (Date.parse(retour) - Date.parse(aller) + 86400000)/86400000;
