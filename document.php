              ...
              <?php if($_SESSION['type'] == 'DG'){ ?>
				...
				<?php if( $_SESSION['type'] != 'CS'){?>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a style="color:white;" href="documentt.php">Stagiaire</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="box">
                            ...
                            <div id="collapseOne" class="accordion-body collapse in body" style="margin-top:30px;">
                                <form target='_blank' action="docum.php" class="form-horizontal block-validate" method="post" id="form1">
                        <div class="form-group">
                             <label class="control-label col-lg-4" style="font-family:Calibri;font-size:30px;font-weight: normal;margin-top:-10px;">Nom de Stagiére</label>
                        <div class="col-lg-4">
  ...
  function data_base_connect ()
   {
     ...
     return ($dbh);
            ...
            $db = data_base_connect ();
             $statement = $db->prepare('SELECT * FROM Stage WHERE Code_PV=?');
            $statement->execute(array($_POST['digits']));
            while($option = $statement->fetch()){ 
                $codestage=$option['Code'];
                  } 
            $statement = $db->prepare('SELECT Chercheur.Code,Nom_Fr,Prénom_Fr FROM Chercheur JOIN Stage WHERE Chercheur.Code=Stage.Chercheur_Code AND Stage.Code_PV=?');
            $statement->execute(array($_POST['digits']));
        while($option = $statement->fetch()){ ?>
          <option value='<?php echo $option['Code'].' '.$codestage; ?>' ><?php echo $option['Nom_Fr'].' '.$option['Prénom_Fr']; ?></option>
                 <?php } ?>
</select> </div>  
                    
                  <input type="hidden" name="oran" id="oran"/>                  
                 <ul class="ca-menu" style="margin-left:10%;margin-top:80px;">
                    <li>
                        <a href="#" data id="submit1">
                            <span class="ca-icon">Z</span>
                            <div class="ca-content">
                                <h2 class="ca-main">Attestation de Stage</h2>
                                <h3 class="ca-sub">Le document de stage</h3>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#" data id="submit2">
                            ...
                            <div class="ca-content">
                                <h2 class="ca-main">Frais d'Inscription</h2>
                                <h3 class="ca-sub">Le document d'inscription</h3>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#" data id="submit3">
                            ...
                            <div class="ca-content">
                                <h2 class="ca-main">Frais d'Allocation</h2>
                                <h3 class="ca-sub">Le document d'allocation</h3>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#" data id="submit4">
                            ...
                            <div class="ca-content">
                                <h2 class="ca-main">Billet de Transport</h2>
                                <h3 class="ca-sub">Le document de transport</h3>
                            </div>
                        </a>
                    </li>
                </ul>
