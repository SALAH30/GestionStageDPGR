                    ...
                    <div class="col-lg-12">
                        <div class="box">
                            ...
                            <div id="collapseOne" class="accordion-body collapse in body" style="margin-top:30px;">
                                    <form method="post" action="document.php" class="form-horizontal block-validate" >
                                         <div class="form-group"  style="margin:30px 0;">
                                            <label for="digits" class="control-label col-lg-4" style="font-family:Calibri;font-size:30px;font-weight: normal;margin-top:-10px;">Le code de PV</label>
                                            <div class=" col-lg-5">
                                            <div class="input-group">
                                                <input class="form-control" type="text" name="digits" id="digits" autofocus/>
                                                <span class="input-group-addon"><i class="icon-zoom-out"></i></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-actions no-margin-bottom" style="text-align:center;">
                             <input class="accordion-toggle minimize-box btn btn-primary btn-lg" type="submit" value="Rechercher" name="submit"/>
                                        </div>
                                    </form>
                        </div>
                    </div>
