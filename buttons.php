  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <div class="sidebar-toggle-box">
                   <div class="fa fa-bars tooltips" data-placement="right" id="afficher" onclick="if (this.id=='afficher') {$('#modal1').css('margin-left','12px');$('#modal2').css('margin-left','344px');this.id='cacher';} else {$('#modal1').css('margin-left','190px');$('#modal2').css('margin-left','484px');this.id='afficher';}" data-original-title="Afficher/Cacher Menu"></div>
              </div>
            ...
            <div class="top-menu">
              <ul class="pull-right top-menu"  id="log">
          ...
          <p class="centered"><a href="accueil.php"><img src="assets/img/personnage/bossDG01.png" class="img-circle" width="100"></a></p>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a style="color:white;" href="buttons.php">Avancée</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
        ...
        <p>Exécution des requêtes complexes dans la BDD</p>

      </header>
              <div class="clearfix" style="margin-bottom:50px;">
              <nav  class="nav" style="margin:50px auto;">
          <ul>
...
$var = array();
$fields=array();
////////////////////////////////////////////////////// Chercheur Join Stage //////////////////////////////////////////////////////////////
if(isset($_POST["requi3"]))
{
        $fields[]="requi3";
        $var[] = "Manifestation.Désignation=?";
        $st = Select_query_cherch_Stage_Man($db,$var,$fields);
}
///////////////////////////////////////////
...
if(isset($_POST["vill"]))
{
        $fields[]="vill";
        $var[] = "Stage.Ville=?";
        $st = Select_query_cherch_Stage($db,$var,$fields);
}
///////////////////////////////////////////
if(isset($_POST["Pays"]))
{
...
if(isset($_POST["datE"]))
{
        ...
        $st = $db->prepare("SELECT * FROM Stage JOIN Chercheur WHERE Chercheur.Code=Stage.Chercheur_Code AND Stage.Date_Prévue_Départ>? AND Stage.Date_Prévue_Retour<?");
        $var[]=$aller;
        $var[]=$retour;
        $st->execute($var);
}
...
if(isset($_POST["datP"]))
{
        ...
        $st = $db->prepare("SELECT * FROM Stage JOIN Chercheur WHERE Chercheur.Code=Stage.Chercheur_Code AND Stage.Date_Effective_Départ>? AND Stage.Date_Effective_Retour<?");
        $var[]=$aller;
        $var[]=$retour;
        $st->execute($var);
}

////////////////////////////////////////////////////// Chercheur Join Université //////////////////////////////////////////////////////////////
if(isset($_POST["required10"]))
{
        $fields[]="required10";
        $var[] = "Université.Nom_Ar=?";
        $st = Select_query_Cher_univ($db,$var,$fields);
}
///////////////////////////////////////////
if(isset($_POST["req12"]))
{
        $fields[]="req12";
        $var[] = "Université.Nom_Fr=?";
        $st = Select_query_Cher_univ($db,$var,$fields);
}
////////////////////////////////////////////////////// Chercheur Join Laboratoire //////////////////////////////////////////////////////////////

if(isset($_POST["nom_dir"])&&isset($_POST["prenom_dir"]))
{
        $fields[]="nom_dir";
        $var[] = "Laboratoire.Nom_Directeur=?";
        $fields[]="prenom_dir";
        $var[] = "Laboratoire.Prénom_Directeur=?";
        $st = Select_query_cherch_labo($db,$var,$fields);
}
///////////////////////////////////////////
if(isset($_POST["require2"]))
{
        $fields[]="require2";
        $var[] = "Laboratoire.Désignation=?";
        $st = Select_query_cherch_labo($db,$var,$fields);
}

////////////////////////////////////////////////////// Stage Join Chercheur //////////////////////////////////////////////////////////////
if(isset($_POST["requis3"]))
{
        $fields[]="requis3";
        $var[] = "Doctorant.Diplome_Base=?";
        $st = Select_query_cherch_Doc_Stage($db,$var,$fields);
}
//////////////////////////////////////////
if(isset($_POST["required4"])&&isset($_POST['required5']))
{
        $fields[]="required4";
        $var[] = "Chercheur.Nom_Ar=?";
        $fields[]="required5";
        $var[] = "Chercheur.Prénom_Ar=?";
        $st = Select_query_cherch_Stage($db,$var,$fields);
}
//////////////////////////////////////////
...
{
        $fields[]="required1";
        $var[] = "Chercheur.Nom_Fr=?";
        $fields[]="required2";
        $var[] = "Chercheur.Prénom_Fr=?";
        $st = Select_query_cherch_Stage($db,$var,$fields);
}
///////////////////////////////////////////
...
if(isset($_POST["req"]))
{
        ...
        $st = Select_query_cherch_Ens_Stage($db,$var,$fields);
}
///////////////////////////////////////////
...
if((isset($_POST["required1"])&&isset($_POST['required2']))||isset($_POST['requis3'])||isset($_POST['required4'])||isset($_POST["Civil"])||isset($_POST["r3"])||isset($_POST["req"])||isset($_POST["dp1"])||isset($_POST["requis4"])||isset($_POST['sport'])||isset($_POST["req1"]))
            ...
            <?php }    ?>
                        <?php if(isset($_POST["datP"])||isset($_POST["datE"])||isset($_POST["requi4"])||isset($_POST["codpv"])||isset($_POST['vill'])||isset($_POST['Pays'])||isset($_POST["requird2"])||isset($_POST['Stage'])||isset($_POST['required'])||isset($_POST['requi3'])||(isset($_POST["nom_dir"])&&isset($_POST['prenom_dir']))||isset($_POST['require2'])||isset($_POST["required10"])||isset($_POST['req12']))
                                { ?>
                                        <tr>
                                      <th>Nom </th>
                                      <th>Prénom </th>
              ...
              <!--  <button style="margin-left:45%;" id="button" onclick="document.getElementById('table').style.display = 'none'; document.getElementById('liste').style.display = 'block';this.style.display='none';window.location='#';" class="btn btn-primary btn-lg btn-round btn-line">Retour</button>-->
    ...
    <div class="modal fade" id="nom_ar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="buttons.php"  method="post" class="formulaire block-validate popup-validation inline-validate">
    ...
    <div class="modal fade" id="prenom" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form  method="post" action="buttons.php" class="formulaire block-validate popup-validation inline-validate">
                <div class="modal-body">
                    <div class="arab form-group">
  ...
  * ================== */
  ...
  <script type="text/javascript">
        ...
        var unique_id = $.gritter.add({
            ...
            text: 'Bounjour monsieur, si vous vouler consulter l\'aide de l\'application <a href="PRO/HTML/avancee.htm" target="_blank" style="color:#ffd777"><h7>help!</h7></a>',
