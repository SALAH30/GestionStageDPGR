...
<?php
    function data_base_connect ()
   {
     ...
     return ($dbh);
              ...
              $st1 = $db->prepare("SELECT suivi_stage.Etat FROM Stage JOIN Suivi_Stage JOIN Chercheur WHERE Chercheur.Code=Stage.Chercheur_Code AND Chercheur.Code = ".$_POST['cherchcod']." AND Stage.Code=suivi_stage.Code_Stage");
              $st2 = $db->prepare("SELECT Date_Prévue_Départ FROM Stage JOIN Chercheur WHERE Chercheur.Code=Stage.Chercheur_Code AND Chercheur.Code = ".$_POST['cherchcod']."");
              $st3 = $db->prepare("SELECT Sexe FROM Chercheur");
              $st5 = $db->prepare("SELECT Nom_Fr FROM Chercheur  WHERE Chercheur.Code = ".$_POST['cherchcod']."");
              $st6 = $db->prepare("SELECT Prénom_Fr FROM Chercheur WHERE Chercheur.Code = ".$_POST['cherchcod']."");
              $st4 = $db->prepare("SELECT Stage.Frais_de_Séjour,Stage.Frais_Transport,Stage.Frais_Visa,Stage.Frais_Assurance FROM Stage JOIN Chercheur WHERE Chercheur.Code=Stage.Chercheur_Code AND Chercheur.Code = ".$_POST['cherchcod']."");
              ...
              $st6->execute();
               while($row6 = $st6->fetch())
              {
                $prenom=$row6['Prénom_Fr'];
              }
              $st2->execute();
...
?>
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title" style="font-family:'Andalus';">Nombre de stages par état</h3>
                </div>
              ...
              <div class="box box-danger">
                <div class="box-header">
                  <h3 class="box-title" style="font-family:'Andalus';">Les frais des stages de <?php echo '"'.$nom.' '.$prenom.'"';?></h3>
                </div>
                <div class="box-body">
            ...
            <div class="col-md-6">
              ...
              <div class="box box-info"  style="display:none;">
                <div class="box-header">
                  <h3 class="box-title" style="font-family:'Andalus';">Nombre d'enseignant par nature</h3>
                </div>
                <div class="box-body">
              ...
              <div class="box box-success">
                <div class="box-header">
                <br><br><br><br>
                  <h3 class="box-title" style="font-family:'Andalus';">Nombre de stages par année</h3>
                </div>
                <div class="box-body">
                  <br><br>
    ...
    <script>
      ...
      $(function () {
        ...
        var PieData = [
          {
            value: <?php echo $Frais_Transport; ?>,
            color: "#3c8dbc",
            highlight: "#f56954",
            label: "Frais de transport"
          },
          {
            value: <?php echo $Frais_Visa; ?>,
            color: "#00a65a",
            highlight: "#f56954",
            label: "Frais de visa"
          },
          {
            value: <?php echo $Frais_de_Séjour; ?>,
            color: "#f39c12",
            highlight: "#f56954",
            label: "Frais de séjour"
          },
          {
            value: <?php echo $Frais_Assurance; ?>,
            color: "#d2d6de",
            highlight: "#f56954",
