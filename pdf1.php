...
<table id="tab"  border="1" ALIGN="center" CELLSPACING="0" style="margin-left:-30px;"> 
    <tr> 
		...
		<td>Frais <br> d’inscription <br> en devise   </td> 
		<td>Taux de<br> change   </td> 
		<td>Frais <br> d’Inscription<br> en DA    </td> 
  
    </tr>  
    <tr>    
		<td style="width:3%;"> <?php echo $cod ?> </td> 
		...
		<td>SCD </td> 
		<td><?php echo $Frais; ?>
        <select name="motif" style="width:60px;">
            <option value="Euros">Euros</option>
            <option value="DA">DA</option>
        </select></td> 

		<td>1Euros = <input type="text" name="Dure" id="Dure" value="107" style="width:36px;"> DA 

       <br></td>
      
        
		<td><br><input type="text" name="Dur" id="Dur" value="<?php echo $Frais*$taux;?>" style="width:82px;"><br> <br></td>
...
<?php 
    ...
    $pdf->Output('Frais_Inscription_'.$nom.'_'.$prenom.'.pdf') ;
 ?>
