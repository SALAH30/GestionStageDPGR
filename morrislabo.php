                    ...
                    <div class="col-lg-12">
                        <div class="box">
                            <header>
                                ...
                                <h5>Les Statistiques de Chercheur</h5>
                                <div class="toolbar">
                                    <ul class="nav">
                                        <li>
                                            <div class="btn-group">
                            ...
                            <div id="collapseOne" class="accordion-body collapse in body" style="margin-top:20px;">
                          <form method="post" action="labostat.php" class="form-horizontal block-validate" >
  ...
  function data_base_connect ()
   {
    ...
    <select class='form-control chzn-select' tabindex='2' name ='Laboratoire_Code'><?php $statement = $db->prepare('SELECT * FROM Laboratoire');$statement->execute();while($option = $statement->fetch()){ ?><option value='<?php echo $option['Code'] ?>' ><?php echo $option['Désignation'];?></option><?php } ?></select>
                            ...
                            <input class="accordion-toggle minimize-box btn btn-primary btn-lg" type="submit" value="Suivant" name="submit"/>
                                        </div>
                                    </form>
                        </div>
                    </div>
