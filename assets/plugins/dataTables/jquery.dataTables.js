...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( oLanguage )
	{
		...
		if ( !oLanguage.sEmptyTable && zeroRecords &&
			oDefaults.sEmptyTable === "Il y a aucune données dans le tableau" )
		{
		...
		if ( !oLanguage.sLoadingRecords && zeroRecords &&
			oDefaults.sLoadingRecords === "Patientez..." )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sEmptyTable": "Il y a aucune donnée dans le tableau",
			 ...
			 *    } );
			 */
			"sInfo": "Afficher _START_ à _END_ parmi _TOTAL_ entrées",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Afficher 0 à 0 parmi 0 entrées",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(filtré parmi _MAX_ totale entrées)",
