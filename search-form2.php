...
<body class="padTop53 ">
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <!--sidebar end-->
        ...
        <div id="content">
                ...
                <form method="post" action="chercheur_insrt.php" id="form1" class="form-horizontal block-validate popup-validation">
                          <hr />
                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            <label for="required1" class="control-label">Le nom</label>
                                                <div class="input-group">
                                                    <input type="text" id="required1" title=" " name="required1" class="form-control" autofocus/>
 ...
 <input type="text" id="required6" autocomplete="off" name="required6" class="form-control" data-provide="typeahead" data-items="8" data-source='["Abdelwaheb","Abbès","abdallah","Abdechahid","Abdelaziz","Abdelbassir","Abdeldjalil","Abdelfettah","Abdelghafour", "Abdelghani","Abdelhadi","Abdelhak","Abdelhakim","Abdelhalim","Abdelkader","Abdelkarim","Abdellatif","Abdelmadjid","Abdelmalik","Abdelmoumen","Abdenour","Abderrahim","Abderrazek", "Abdessalem","Abdessatar","Abed","Abid","Abou Bakr", "Achik","Achir","Achour","Achraf","Adam","Adel","Adib","Adil","Adnane","Afdal","Ahmed", "Aissa", "Akli","Akmar","Alaeddine","Ali","Allal","Allaoua","Abdelbassir","Abdeldjalil","Abdelfettah","Abdelghafour","Abdelghani","Abdelhadi", "Abdelhak", "Abdelhakim","Abdelhalim","Abdelkader","Abdelbassir","Abdeldjalil","Abdelfettah","Abdelghafour","Abdelghani","Abdelhadi","Abdelhak", "Abdelhakim", "Abdelhalim","Abdelkader","Amar","Amine","Amir","Amjad","Anas","Anis","Anouar","Antar","Arsalane","Araslane","Assim","Assad","Atmane", "Ayachi", "Ayoub","Azhar","Azzam","Azziz","Azzouz","Bachir","Badreddine","Bahi","Bakir", "Baligh", "Basile","Bassim","Belkacem","Bilal", "Boualem","Boubaker", "Boudjemaa","Boumedienne","Bouziane","Bouzid","Chabane","Chafik","Chahid", "Chahine","Chaker", "Chakib","Chamseddine","Chawki","Chedli","Cheikh", "Cherif","Chokri", "Daoud","Djafar","Djallel","Djallil","Djamel","Djamil","Djelloul","Djillali","Driss","Elias","Fadel","Fadi","Fahd","Fahim","Fahmi","Fares","Farid", "Farouk","Fathi","Foudil","Fawzi","Fayçal","Ferhat","Fouad","Gebril","Ghalib","Ghanem","Ghani","Ghazi","Habib","Hachem","Hadi","Hadj", "Hafid","Hafs","Haider","Hakim","Halim","Hamdane","Hamid", "Hamza","Hani", "Haroun","Hassen","Hatim","Hichem","Hikmet","Hilal","Hocine", "Houari","Houd", "Ibrahim","Idriss","Ikhlas","Ilian","Ilyes","Ishak","Islem","Ismaïl","Ismet","Jabar","Jaber","Jahid","Djahid","Jawed","Kamel", "Kaci", "Kader","Karim","Khaldoun","Khaled","Khalil","Kheireddine", "Kamir", "Lamine", "Lakhdar","Larbi", "Lotfi","Lounès","Lout","Maamar","Maarouf","Mabrouk", "Madani", "Mahboub","Mahfoud","Mahmoud","Makhlouf","Malek", "Malik","Marouane","Marwan", "Mehdi","Mekki", "Messaoud","Mohamed","Mokhtar","Moncef","Mouley","Mounir","Mourad","Moussa","Mustapha","Nabil","Nacer", "Nacer-Eddine","Nadim","Nadir","Nadji","Nadjib","Nahil","Naïm","Nassim","Nazim", "Nazir","Nouh", "Nourredine","Omar","Okacha","Osmane","Othmane","Oussama","Rabah","Rachid","Rafik","Rahal","Raïd","Rami","Ramzi","Raouf","Rayan","Razi", "Réda", "Redouane","Riad","Rochdi","Rostom","Rabia","Rabha","Racha","Rachida","Radia","Sabri","Said","Salah","Salah Eddine","Salih","Salim","Sami","Samy", "Samir","Sayed","Seddik","Sofiane","Tahar","Tarek","Tarik","Tayeb","Tijani","Toufik","Walid","Wahid","Wassim","Yacine","Yassine","Yacoub","Yamine","Yanis","Yazid","Youcef","Younes","Zahir", "Zahid","Zahi","Zaïm","Zakaria","Zaki", "Ziad","Zine-Eddine","Zoubir","Zoheir"]'/>
                    ...
                    <div class="form-group">
                        <label for="required8" class="control-label">Date de naissance</label>
                            <div class="input-group">
                                <input class="form-control" type="text" data-mask="99/99/9999" id="required8" name="required8"/>
                ...
                <section>
                                    ...
                                    <label for="required4"style="font-size: 20px;" class="control-label col-lg-12">اللقب</label>
                                            <div class="arab">
                                                ...
                                                <input dir="rtl" lang="ar" type="text" title=" " id="required4" name="required4" class="form-control"/>
                                                </div>
                                             </div> 
                                         </div>
                                         <div class="form-group">
 ...
 <input dir="rtl" lang="ar" autocomplete="off" type="text" id="required7" name="required7" class="form-control" data-provide="typeahead" data-items="6" data-source='["صلاح الدين","فضيل","خليل","وليد","عبد الحق","إبراهيم","أحمد","إدريس","إسحاق","إسماعيل","أيوب","يعقوب","عيسى","يونس","هارون","جبريل","داوود","رزق","رضوان","زكرياء","يحيى","إلياس","زيد","سليمان","صالح","عمران","لقمان","محمد","موسى","نوح","هارون","هود","ياسين","يعقوب","يوسف","يونس"]'/>
                                            </div>
                                            </div>
                                        </div></br>
                <div class="form-group">
                    <input type="hidden" name="r3" value="Masculin" id="btn-input"/>
                    <div class="btn-group" data-toggle="buttons">
                    <label style="margin-left:170px;font-size: 20px;" class="btn btn-primary">
                      <input type="radio" name="r3" value="Féminin" id="option2"/>
                        أنثى
                    </label>
                    <label style="margin-left:170px;font-size: 20px;" class="btn btn-primary active">
                      <input type="radio" name="r3" value="Masculin" id="option1" checked/>
                        ذكر
                    </label>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label for="digits" class="control-label">Laboratoire Désignation</label>
                                                <div class="input-group">  
                                                  <select class='form-control chzn-select' tabindex='2' name ='Laboratoire_Code'><?php $statement = $db->prepare('SELECT * FROM Laboratoire');$statement->execute();while($option = $statement->fetch()){ ?><option value='<?php echo $option['Code'] ?>' ><?php echo $option['Désignation'];?></option><?php } ?></select>
                                                </div>
                                             <!--    <span class="help-block">Le code de laboratoire</span>-->
                                            </div>                                      
                </section>

                <h2>Type de Chercheur</h2>
                <section>
                    <p style="color:gray;font-size:1.3em;">
                        <b style="margin-left:200px;text-transform:uppercase;"> Choix de Chercheur</b> <br /><br /><br />
                        Le chercheur doit être soit un enseignant ou un doctorant ou juste un travailleur.<br /><br /><br />
                        Veuillez choisir le type de chercheur parmi qui convient :<br /><br />
                        <button style="margin-left:30px;" type="button" class="btn btn-primary btn-lg" id="aissa">Enseignant</button>
                        <button style="margin-left:20px;" type="button" class="btn btn-primary btn-lg" id="belkaid">Doctorant</button>
                        <button style="margin-left:20px;" type="button" class="btn btn-primary btn-lg" id="aissaBelkaid">Ens/Doct</button>
                        <button style="margin-left:20px;" type="button" class="btn btn-primary btn-lg" name="oran" id="oran" >Travailleur</button>  
                        <br /><br /><br /><br />Quel est votre choix s'il vous plait ?
                        <br />    
                    </p>
                </section>
            </div>           
    ...
    <script>
        ...
        var button = $("#wizardV").find('a[href$="#finish"]'),
                     parrent = button.parent();
                    // parrent.addClass('disabled');
                    parrent.addClass('claissa');
       $("#wizardV").on('click','#aissa',function(){
        // Add steps
           wizard.steps("add", {
                title: "Les Informations de l'Enseignant", 
                content: "<br \><div class='form-group'><label class='control-label'>L'université</label><select class='form-control chzn-select' tabindex='2' name ='Pays'><?php $statement = $db->prepare('SELECT * FROM Université');$statement->execute();while($option = $statement->fetch()){ ?><option value='<?php echo $option['Code'] ?>' ><?php echo $option['Nom_Fr'];?></option><?php } ?></select></div><div class='form-group'><label for='req' class='control-label'>Le grade</label><input type='text' class='form-control' name='req' id='req'  data-source= '[\"Vacataire\",\"Professeur\",\"Maître de conférence A\",\"Maître de conférence B\",\"Maître assistant A\",\"Maître assistant B\"]' autocomplete='off' data-provide='typeahead' data-items='6'></div><div class='form-group'><label for='req1' class='control-label'>La spécialité</label><input type='text' class='form-control validate[required]' title=' ' name='req1' id='req1' data-source= '[\"Analyse\",\"Algébre\",\"Eléctronique\",\"Mécanique\",\"Informatique\",\"Economie\",\"Bureautique\",\"Assembleur\",\"Eléctricité\",\"Architecture\",\"Anglais\",\"Français\",\"Logique mathématique\",\"Optique\",\"Programmation orientée objet\",\"Système d&acute;information\",\"Système d&acute;exploitation\",\"Réseau\",\"Sécurité\",\"Propabilité et statistique\"]' autocomplete='off' data-provide='typeahead' data-items='4'></div><div class='form-group'><label for='sport' class='control-label'>Nature</label><select name='sport' id='sport' class='validate[required] form-control'><option value='Permanent'>Permanent</option><option value='Vacataire'>Vacataire</option><option value='Associé'>Associé</option></select></div>"
            }); 
           wizard.steps("add", {
                title: "Les Dates Appropriées", 
                content: "<br \><br /><div class='form-group'><label class='control-label' for='dp3'>Date de recrutement</label><div class='input-group'><input type='text' class='validate[required,custom[date]] form-control' value='14/03/2012' name='dp3' id='dp3' /><span class='input-group-addon'><i class='fa fa-calendar'></i></span></div></div><br /><br /><br /><br /><div class='form-group'><label class='control-label' for='dp2'>Date de nomination</label><div class='input-group'><input type='text' class='validate[required,custom[date]] form-control' value='24/05/2013' name='dp2' id='dp2'/><span class='input-group-addon'><i class='fa fa-calendar'></i></span></div></div>"
            });
            $(function () { formValidation();});
            $(function () { formInit();});
            wizard.steps("next");
           ...
           // parrent.removeClass('disabled');
            parrent.removeClass('claissa');
        });
    $("#wizardV").on('click','#belkaid',function(){
        // Add steps
           wizard.steps("add", {
                title: "Les Informations de Doctorant", 
                content: '<br \><div class="form-group"><label for="requis3" class="control-label">Diplôme de base</label><input type="text" class="form-control validate[required]" title=" " name="requis3" id="requis3" data-source= \'[\"PHD\",\"Ingénieur\",\"Licence\",\"Master 1\",\"Master 2\",\"Doctorat\"]\' autocomplete="off" data-provide="typeahead" data-items="4"></div><div class="form-group"><label for="requis4" class="control-label">Diplôme à préparer</label><input type="text" class="form-control validate[required]" title=" " name="requis4" id="requis4" data-source= \'[\"PHD\",\"Ingénieur\",\"Licence\",\"Master 1\",\"Master 2\",\"Doctorat\"]\' autocomplete="off" data-provide="typeahead" data-items="6"></div><div class="form-group"><label class="control-label" for="dp1">Date d\'inscription</label><div class="input-group"><input type="text" class="form-control" value="11/02/2012" name="dp1" id="dp1"/><span class="input-group-addon"><i class="fa fa-calendar"></i></span></div></div><div class="form-group"><label for="req5" class="control-label">Sujet de Thèse</label><input type="text" class="form-control validate[required]"  name="req5" id="req5"></div>'
            }); 
           wizard.steps("add", {
                title: "L'Encadreur", 
                content: '<br \><div class="form-group"><label for="req6" class="control-label">Nom de l\'Encadreur</label><div class="input-group"><input type="text" class="form-control validate[custom[name]]" title=" " name="req6" id="req6"><span class="input-group-addon"><i class="fa fa-user"></i></span></div></div><div class="form-group"><label for="req7" class="control-label">Prénom de l\'Encadreur</label><div class="input-group"><input type="text" autocomplete="off" class="form-control validate[custom[name]]" title=" " name="req7" id="req7" data-provide="typeahead" data-items="8" data-source=\'["Abdelwaheb","Abbès","abdallah","Abdechahid","Abdelaziz","Abdelbassir","Abdeldjalil","Abdelfettah","Abdelghafour", "Abdelghani","Abdelhadi","Abdelhak","Abdelhakim","Abdelhalim","Abdelkader","Abdelkarim","Abdellatif","Abdelmadjid","Abdelmalik","Abdelmoumen","Abdenour","Abderrahim","Abderrazek", "Abdessalem","Abdessatar","Abed","Abid","Abou Bakr", "Achik","Achir","Achour","Achraf","Adam","Adel","Adib","Adil","Adnane","Afdal","Ahmed", "Aissa", "Akli","Akmar","Alaeddine","Ali","Allal","Allaoua","Abdelbassir","Abdeldjalil","Abdelfettah","Abdelghafour","Abdelghani","Abdelhadi", "Abdelhak", "Abdelhakim","Abdelhalim","Abdelkader","Abdelbassir","Abdeldjalil","Abdelfettah","Abdelghafour","Abdelghani","Abdelhadi","Abdelhak", "Abdelhakim", "Abdelhalim","Abdelkader","Amar","Amine","Amir","Amjad","Anas","Anis","Anouar","Antar","Arsalane","Araslane","Assim","Assad","Atmane", "Ayachi", "Ayoub","Azhar","Azzam","Azziz","Azzouz","Abla","Abida","Achika","Achwak","Adiba","Adila","Adra","Afaf","Afia","Afifa","Afnane","Ahlem", "Aïcha","Aïda","Akila","Alia","Aliya","Amana", "Amaria","Amber","Amel","Amina","Amira","Amra","Anane","Angham","Anika","Anissa","Aouatif", "Awatif","Ariba","Asma","Asrar","Assia","Atefa", "Atifa", "Atika","Aya","Azhar","Aziza","Azza","Bachir","Badreddine","Bahi","Bakir", "Baligh", "Basile","Bassim","Belkacem","Bilal", "Boualem","Boubaker", "Boudjemaa","Boumedienne","Bouziane","Bouzid","Bachira","Bachra","Badia", "Badira","Badra","Bahia","Bahidja","Bahdja","Bakhta","Bariza","Basma","Baya","Bouchra","Bouthaïna","Chabane","Chafik","Chahid", "Chahine","Chaker", "Chakib","Chamseddine","Chawki","Chedli","Cheikh", "Cherif","Chokri","Camila","Kamila","Calaa","Cantara","Chadia","Chafia","Chafika", "Chahéra","Chahida","Chahinez","Chahra","Chahrazad","Chaïma","Chakira","Chakiba","Chama","Chérifa","Chirine","Chaza","Chourouk", "Daoud","Djafar","Djallel","Djallil","Djamel","Djamil","Djelloul","Djillali","Driss","Dalal","Dalia","Dalila","Deloula","Dawiya","Dehbia","Djamila","Djawida","Djohar","Dhohra","Dora","Douha","Douja","Dounia","Drifa","
Racha","Rachida","Radia","Rafika","Rahima","Rahma","Rahifa","Raïda","Raihane","Raïssa", "Raja","Ratiba","Rawda","Razika","Riheb","Rima","Ryma","Rita","Rokia","Rosa","Sabri","Said","Salah","Salah Eddine","Salih","Salim","Sami","Samy", "Samir","Sayed","Seddik","Sofiane","Sabah","Sabiha","Sabrina","Sabriya","Sadika","Sadjia","Safa","Safia","Saïda","Sajida","Sakina","Saliha","Salima","Saloua","Samar","Samia","Samiha","Samira","Samra","Sana","Sania","Sara","Sarah","Sawsene","Siham","Selma","Sihame","Sofia","Soltana","Sonia","Soraya","Souad","Souhila","Soumia","Tahar","Tarek","Tarik","Tayeb","Tijani","Toufik","Tahani","Tahira","Tamara","Taous","Thania","Tania","Tlidja","Torkia","Tounes","Touraya","Walid","Wahid","Wassim","Wafa","Wahiba","Wahida","Walida","Warda","Wassila","Widad","Wissel","Yacine","Yassine","Yacoub","Yamine","Yanis","Yazid","Youcef","Younes","Yamina","Yasmina","Yasmine","Youmna","Yousra","Yakout","Zahir", "Zahid","Zahi","Zaïm","Zakaria","Zaki", "Ziad","Zine-Eddine","Zoubir","Zoheir","Zahia","Zahida","Zahra","Zahira","Zakia","Zanouba","Zayane","Zehouania","Zeïna","Zineb", "Zohra","Zoubida", "Zoulikha"]\'><span class="input-group-addon"><i class="fa fa-user"></i></span></div></div><div class="form-group"><label for="req8" class="control-label">Grade de l\'Encadreur</label><input type="text" class="form-control" title=" " name="req8" id="req8" data-source= \'[\"Vacataire\",\"Professeur\",\"Maître de conférence A\",\"Maître assistant A\",\"Maître de conférence B\",\"Maître assistant B\"]\' autocomplete="off" data-provide="typeahead" data-items="6"></div><div class="form-group"><label for="req9" class="control-label">Etablissement de l\'Encadreur</label><div class="input-group"><input type="text" class="form-control" title=" " name="req9" id="req9"><span class="input-group-addon"><i class="fa fa-building"></i></span></div></div>'
            });
             wizard.steps("add", {
                title: "Le Co Encadreur", 
                content: '<br \><div class="form-group"><label for="req10" class="control-label">Nom de Co Encadreur</label><div class="input-group"><input type="text" class="form-control" name="req10" id="req10"><span class="input-group-addon"><i class="fa fa-user"></i></span></div></div><div class="form-group"><label for="req11" class="control-label">Prénom de Co Encadreur</label><div class="input-group"><input type="text" autocomplete="off" class="form-control" name="req11" id="req11" data-provide="typeahead" data-items="8" data-source=\'["Abdelwaheb","Abbès","abdallah","Abdechahid","Abdelaziz","Abdelbassir","Abdeldjalil","Abdelfettah","Abdelghafour", "Abdelghani","Abdelhadi","Abdelhak","Abdelhakim","Abdelhalim","Abdelkader","Abdelkarim","Abdellatif","Abdelmadjid","Abdelmalik","Abdelmoumen","Abdenour","Abderrahim","Abderrazek", "Abdessalem","Abdessatar","Abed","Abid","Abou Bakr", "Achik","Achir","Achour","Achraf","Adam","Adel","Adib","Adil","Adnane","Afdal","Ahmed", "Aissa", "Akli","Akmar","Alaeddine","Ali","Allal","Allaoua","Abdelbassir","Abdeldjalil","Abdelfettah","Abdelghafour","Abdelghani","Abdelhad
adra","Khalida","Kheira","Kinda", "Lamine", "Lakhdar","Larbi", "Lotfi","Lounès","Lout","Lilya","Lamia","Lalla","Lebiba","Latifa","Leila","Lilia","Lina","Linda","Loubna","Louisa", "Loundja", "Loutfia","Maamar","Maarouf","Mabrouk", "Madani", "Mahboub","Mahfoud","Mahmoud","Makhlouf","Malek", "Malik","Marouane","Marwan", "Mehdi","Mekki", "Messaoud","Mohamed","Mokhtar","Moncef","Mouley","Mounir","Mourad","Moussa","Mustapha","Mabrouka","Madiha","Maha","Mahbouba","Mahdia","Mahera","Maïssa","Majda","Majida","Malika","Manel","Mansoura","Mansouria","Maria","Maya","M&#39;Barka","Mellina","Meimouna","Meriem","Messaouda","Mordjane","Mordjana","Moufida","Mouna","Mounia","Mounira","Nabil","Nacer", "Nacer-Eddine","Nadim","Nadir","Nadji","Nadjib","Nahil","Naïm","Nassim","Nazim", "Nazir","Nouh", "Nourredine","Nabiha","Nabila","Nachida","Nacira","Nadia","Nadira","Nadjia","Nadjiba","Nadra","Nafissa","Nahla", "Naïla","Neïla", "Naïma","Najet","Nariman","Narjes","Nawel","Naziha","Nedjma","Nedjwa","Nezha","Nesrine","Nora","Noria","Noujoud","Nour","Nouzha","Omar","Okacha","Osmane","Othmane","Oussama","Ouardia","Oum El Kheir","Rabah","Rachid","Rafik","Rahal","Raïd","Rami","Ramzi","Raouf","Rayan","Razi", "Réda", "Redouane","Riad","Rochdi","Rostom","Rabia","Rabha","Racha","Rachida","Radia","Rafika","Rahima","Rahma","Rahifa","Raïda","Raihane","Raïssa", "Raja","Ratiba","Rawda","Razika","Riheb","Rima","Ryma","Rita","Rokia","Rosa","Sabri","Said","Salah","Salah Eddine","Salih","Salim","Sami","Samy", "Samir","Sayed","Seddik","Sofiane","Sabah","Sabiha","Sabrina","Sabriya","Sadika","Sadjia","Safa","Safia","Saïda","Sajida","Sakina","Saliha","Salima","Saloua","Samar","Samia","Samiha","Samira","Samra","Sana","Sania","Sara","Sarah","Sawsene","Siham","Selma","Sihame","Sofia","Soltana","Sonia","Soraya","Souad","Souhila","Soumia","Tahar","Tarek","Tarik","Tayeb","Tijani","Toufik","Tahani","Tahira","Tamara","Taous","Thania","Tania","Tlidja","Torkia","Tounes","Touraya","Walid","Wahid","Wassim","Wafa","Wahiba","Wahida","Walida","Warda","Wassila","Widad","Wissel","Yacine","Yassine","Yacoub","Yamine","Yanis","Yazid","Youcef","Younes","Yamina","Yasmina","Yasmine","Youmna","Yousra","Yakout","Zahir", "Zahid","Zahi","Zaïm","Zakaria","Zaki", "Ziad","Zine-Eddine","Zoubir","Zoheir","Zahia","Zahida","Zahra","Zahira","Zakia","Zanouba","Zayane","Zehouania","Zeïna","Zineb", "Zohra","Zoubida", "Zoulikha"]\'><span class="input-group-addon"><i class="fa fa-user"></i></span></div></div><div class="form-group"><label for="req12" class="control-label">Grade de Co Encadreur</label><input type="text" class="form-control" name="req12" id="req12" data-source= \'[\"Vacataire\",\"Professeur\",\"Maître de conférence A\",\"Maître assistant A\",\"Maître de conférence B\",\"Maître assistant B\"]\' autocomplete="off" data-provide="typeahead" data-items="6"></div><div class="form-group"><label for="req13" class="control-label">Etablissement de Co Encadreur</label><div class="input-group"><input type="text" class="form-control" name="req13" id="req13"><span class="input-group-addon"><i class="fa fa-building"></i></span></div></div>'
            }); 
            wizard.steps("add", {
                title: "En Plus", 
                content: '<div class="form-group" style="margin-top:-15px;"><label for="req14" class="control-label">Fonction</label><input type="text" class="form-control" name="req14" id="req14"></div><div class="form-group"><label for="req15" class="control-label">Etablissement de travail</label><div class="input-group"><input type="text" class="form-control" name="req15" id="req15"><span class="input-group-addon"><i class="fa fa-building"></i></span></div></div><div class="form-group"><label for="req16" class="control-label">Lieu de travail</label><div class="input-group"><input type="text" class="form-control" name="req16" id="req16"><span class="input-group-addon"><i class="fa fa-home"></i></span></div></div><div class="form-group"><label for="req17" class="control-label">Etablissement Cotutelle</label><input type="text" class="form-control validate[required]" title=" " name="req17" id="req17"></div><div class="form-group"><label for="req18" class="control-label">Laboratoire Cotutelle</label><input type="text" class="form-control validate[required]" title=" " name="req18" id="req18"></div>'
            });
        ...
        $("#wizardV").on('click','#oran',function(){
            wizard.steps("previous");
            wizard.steps("remove",3);
            parrent.removeClass('claissa'); 
        });
        $("#wizardV").on('click','#aissaBelkaid',function(){
           wizard.steps("add", {
                title: "Les Informations de l'Enseignant", 
                content: "<br \><div class='form-group'><label class='control-label'>L'université</label><select class='form-control chzn-select' tabindex='2' name ='Pays'><?php $statement = $db->prepare('SELECT * FROM Université');$statement->execute();while($option = $statement->fetch()){ ?><option value='<?php echo $option['Code'] ?>' ><?php echo $option['Nom_Fr'];?></option><?php } ?></select></div><div class='form-group'><label for='req' class='control-label'>Le grade</label><input type='text' class='form-control' name='req' id='req'  data-source= '[\"Vacataire\",\"Professeur\",\"Maître de conférence A\",\"Maître assistant A\",\"Maître de conférence B\",\"Maître assistant B\"]' autocomplete='off' data-provide='typeahead' data-items='6'></div><div class='form-group'><label for='req1' class='control-label'>La spécialité</label><input type='text' class='form-control validate[required]' title=' ' name='req1' id='req1' data-source= '[\"Analyse\",\"Algébre\",\"Eléctronique\",\"Mécanique\",\"Informatique\",\"Economie\",\"Bureautique\",\"Assembleur\",\"Eléctricité\",\"Architecture\",\"Anglais\",\"Français\",\"Logique mathématique\",\"Optique\",\"Programmation orientée objet\",\"Système d&acute;information\",\"Système d&acute;exploitation\",\"Réseau\",\"Sécurité\",\"Propabilité et statistique\"]' autocomplete='off' data-provide='typeahead' data-items='4'></div><div class='form-group'><label for='sport' class='control-label'>Nature</label><select name='sport' id='sport' class='validate[required] form-control'><option value='Permanent'>Permanent</option><option value='Vacataire'>Vacataire</option><option value='Associé'>Associé</option></select></div>"
            }); 
  ...
  $(document).on('focus.typeahead.data-api', '[data-provide="typeahead"]', function (e) {
   ...
   /* $('#exampleModal').on('show.bs.modal', function (event) {
        ...
        var unique_id = $.gritter.add({
            title: 'Bonjour ADPGR!',
            text: 'Bounjour monsieur, si vous vouler consulter l\'aide de l\'application <a href="PRO/HTML/ajouter_un_chercheur.htm" target="_blank" style="color:#ffd777"><h7>help!</h7></a>',
